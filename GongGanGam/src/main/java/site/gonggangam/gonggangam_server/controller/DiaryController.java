...
public class DiaryController {
    ...
    public ResponseEntity<DiaryResponseDto> postDiary(
            ...
            @Parameter(description = "일기 상세 내용을 application/json 형식으로 입력 받습니다.", content = @Content(schema = @Schema(implementation = DiaryRequestDto.class), mediaType = MediaType.APPLICATION_JSON_VALUE))
            @ModelAttribute DiaryRequestDto body
            ) {
        return null;
    }
